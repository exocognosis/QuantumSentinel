...
## 2026-08-05 — Readiness scope and scan-posture pass

- Source visual truth: `/var/folders/bj/_phs_kq57hv8lw5bg8mhqn7r0000gn/T/codex-clipboard-f6ac4eb0-cfab-42a4-b18e-b54bdc33017d.png` (3420 x 2214).
- Implementation screenshot: `/Users/rickglenn/Documents/QuantumSentinel/implementation-score-scope.png` (2000 x 1385), captured in the Codex in-app browser at the desktop dark-theme Overview state.
- Added a functional score-scope selector while preserving the source navigation, card grid, typography, icons, radii, palette, and dashboard density.
- `Overall organization` retains the single Quantum Readiness Score and organizational drivers.
- Website, device, and authorized-network selections are explicitly labeled `Observed crypto posture` and use algorithm, evidence completeness, protocol, certificate, and forward-secrecy observations from that scan.
- The selected scope consistently filters the three adjacent metrics and Top priorities.
- Verified Website, Authorized network, and Overall organization states. Browser console errors: none.
- Initial P2 ambiguity: the per-scan ring retained the label `Readiness`. Fixed it to `Posture` and recaptured the implementation.
- Remaining P3: unusually long target names may benefit from explicit truncation at narrower desktop widths.
